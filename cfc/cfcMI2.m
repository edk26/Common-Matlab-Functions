...
s=size(amp,1);
zmi=zeros(ac,pc);  %Comment for GPU

Psurr=zeros(nbin,niter);    %Comment for GPU
parfor np=1:pc   %Parallel %faster if you have parallel for the phase not amp
    
    shift=randi(s,1,niter)';
